...
parameters = {
    'n_estimators': np.arange(10,200),#[10,15,20,50,100,150],
    # 'min_samples_leaf' : np.arange(1,10),#[1,2,3,4,5,6,7],
    # 'min_samples_split' : np.arange(2,10,),#[2,3,4]
    'max_depth' : np.arange(2,50)#[3,4,5,6,7,8,9,10]
}
...
'''
최적의 매개변수 =  {'n_estimators': 109, 'max_depth': 7}
훈련 정확도 = 0.9588526316376543
R2: 0.9338507044633401
'''