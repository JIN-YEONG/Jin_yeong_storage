...
parameters ={
    'max_depth' : np.arange(2,11),#[3,4,5,6,7,8,9,10],
    'learning_rate' : [0.01, 0.05, 0.1, 0.5]#np.arange(0.1,0.6,0.1)
}
...
search = RandomizedSearchCV(GradientBoostingRegressor(),
                            parameters,
                            n_iter=10,
                            n_jobs=-1,
                            cv = kfold_cv
...
'''
최적의 매개변수 =  {'max_depth': 5, 'learning_rate': 0.05}
훈련 정확도 = 0.9603431401718519
R2: 0.933606026786469
'''