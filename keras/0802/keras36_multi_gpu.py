...
num_gpu = 0   # gpu의 개수 입력
inputs = None   # input 데이터
output = None   # output 데이터
...
def build_network(num_gpu=1, input_shape = None):
    ...
    d2 = Dropout(rate=0.2, name='dropout2')(d1)
